...
exports.schemaUsuario = new mongoose_1.Schema({
    dni: Number,
    correo: {
        required: true,
        type: String,
...
exports.schemaUsuario.pre('save', function (next) {
...
exports.schemaUsuario.methods.comparePassword = function (password) {
    return bcryptjs_1.default.compare(password, this.contraseña);
};
var Usuario = mongoose_1.model('Usuario', exports.schemaUsuario, 'usuarios');
